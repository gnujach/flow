        ...
        <div class="flex flex-wrap justify-between items-center">
            <div class="flex justify-start items-center w-1/3">
                <button type="button" @click="toggleNavBar"
                    ...
                    value="Open sidebar">
                    <Bars3Icon name="open_menu" class="h-6 w-6 text-black mx-2 cursor-pointer" v-if="!statusSideBar" />
                    <x-icon class="h-6 w-6 text-black mx-2 cursor-pointer" v-else />
                </button>
                <jet-nav-link :href="route('dashboard.list')">
                    ...
                    <span
                        class="self-center text-lg font-semibold whitespace-nowrap dark:text-white hidden md:block">Flujo
                        de Servicio</span>
                </jet-nav-link>
            </div>
            <div class="flex items-center">
                <MagnifyingGlassIcon class="md:hidden h-6 w-6 text-gray-500 mx-2" />
