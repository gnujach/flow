                        ...
                        <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
                            <div class="mt-8 flex flex-row m-2">
                                ...
                                <div class="w-1/2 flex justify-end">
                                    <jet-nav-link :href="route('admin.medios/create', {})"><button
                            ...
                            <div class="bg-white rounded shadow overflow-x-auto ml-4 mr-4">
                                <table class="w-full">
                                    ...
                                    <tr v-for="medio in medios.data.medios" :key="medio.data.id"
                                        class="hover:bg-gray-100 focus-within:bg-gray-100" :class="[
                                            medio.data.attributes.activo == 0
                                                ? 'text-gray-400'
                                                : '',
                                        ]">
                                        <td class="border-t">
