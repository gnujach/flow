            ...
            <div
                ...
                <div class="flex flex-row">
                    <div class="flex">
                        ...
                        <span :class="{
                            'border-b-2 border-b-blue-400 text-lg font-semibold':
                                selectIndexTab == 0,
                        }">
        ...
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            <div
                ...
                <TabGroup :selectedIndex="selectIndexTab">
                    <TabList>
                        <Tab>
                            <p class="text-2xl font-bold center" :class="{
                                'visible ': selectIndexTab == 0,
                                hidden: selectIndexTab != 0,
                            }">
                        ...
                        <Tab>
                            <div class="flex flex-row justify-around" :class="{
                                visible: selectIndexTab == 1,
                                hidden: selectIndexTab != 1,
                            }">
                                <div class="w-2/3">
                                    <p class="text-2xl font-bold">Requisitos</p>
                                </div>
                            </div>
                        </Tab>
                        <Tab>
                            <p class="text-2xl font-bold" :class="{
                                visible: selectIndexTab == 2,
                                hidden: selectIndexTab != 2,
                            }">
                                Tareas
                            </p>
                        </Tab>
                    ...
                    <TabPanels>
                                ...
                                <div
                                    ...
                                    <div class="col-span-1 md:col-span-2">
                                        <div class="flex flex-col w-full items-start justify-start">
                                            ...
                                            <jet-input id="nombre" type="text"
                                                class="mt-1 w-full mx-auto border-blue-500" autofocus
                                                v-model="form.nombre" autocomplete="nombre" @blur="validate" />
                                    ...
                                    <div class="col-span-1 md:col-span-2">
                                        <div class="flex flex-col w-full col-span-2">
                                            ...
                                            <jet-input id="objetivo" type="text" class="mt-1 border-blue-500"
                                                v-model="form.objetivo" @blur="validate" />
                                    ...
                                    <div class="col-span-3">
                                        <div class="flex flex-col w-full">
                                            ...
                                            <jet-input id="fundamento_jur" type="text"
                                                class="mt-1 w-full border-blue-500" v-model="form.fundamento_jur" />
                                            <jet-input-error :message="form.errors.fundamento_jur
                                                " class="mt-2" />
                                        </div>
                                    </div>
                                    <div class="flex flex-col w-full items-end">
                                        <jet-label for="costo" value="Costo" class="w-full text-lg font-semibold" />
                                        <jet-input id="costo" type="text" class="mt-1 w-full border-blue-500"
                                            v-model="form.costo" />
                                        <jet-input-error :message="form.errors.costo" class="mt-2" />
                                    </div>
                                    <div class="flex flex-col w-full">
                                        <jet-label for="plazo" value="Plazo de Respuesta (días)"
                                            class="text-lg font-semibold" />
                                        <jet-input id="plazo" type="text" class="mt-1 border-blue-500"
                                            v-model="form.plazo_respuesta" @blur="validate" />
                                        <jet-input-error :message="form.errors.plazo_respuesta
                                            " class="mt-2" />
                                    </div>
                                    <div class="flex flex-col">
                                        <jet-label for="modalidad" value="Modalidad de Atención"
                                            class="text-lg font-semibold" />
                                        <BaseListbox :options="modalidad" placeholder="Seleccione Modalidad"
                                            v-model="form.modalidad_id" />
                                    </div>
                                    <div class="flex flex-col">
                                        <jet-label for="tipo_usuario" value="Tipo de Usuario"
                                            class="text-lg font-semibold" />
                                        <BaseListbox :options="tipoUsuarios" placeholder="Seleccione Tipo de Usuario"
                                            v-model="form.tipo_usuario_id" />
                                    </div>
                                    <div class="flex flex-col">
                                        <jet-label for="tipo_departamento" value="Departamento"
                                            class="text-lg font-semibold" />
                                        <BaseListbox :options="departamentosList" placeholder="Seleccione Departamento"
                                    ...
                                    <div class="flex flex-col">
                                        <jet-label for="ser_recibido" value="Documento o Servicio Recibido"
                                            class="text-lg font-semibold" />
                                        <BaseListbox :options="ser_recibo" placeholder="Obtiene"
                                            v-model="form.ser_recibido_id" />
                                    </div>
                                    <div class="flex flex-col">
                                        <jet-label for="tipo" value="Tipo de Trámite" class="text-lg font-semibold" />
                                        <BaseListbox :options="tipos" placeholder="Seleccione Tipo"
                                    ...
                                    <div class="flex flex-col items-center">
                                        <jet-label for="url_proceso" value="Url Proceso"
                                            class="text-lg font-semibold" />
                                        <jet-input id="url_proceso" type="text" class="mt-1 border-blue-500"
                                            @blur="validate" v-model="form.url_proceso" />
                                        <jet-input-error :message="form.errors.url_proceso" class="mt-2" />
                                    </div>
                                    <div class="flex flex-col">
                                        <jet-label for="activo" value="Activo" class="text-lg font-semibold" />
                                        <Switch v-model="form.activo" name="enabled" :class="form.activo
                                            ? 'bg-teal-900'
                                            : 'bg-teal-200'
                        ...
                        <TabPanel>
                            ...
                            <div class="max-w-8xl">
                                <div class="grid grid-row-4 grid-cols-4 gap-4 max-h-96">
                                    <div class="col-span-3">
                                        <div
                                            ...
                                            <div v-for="requisito in $page.props
                                                .requisitos" :class="[
                                                    active
...
req, index
                                                ...
                                                <span>
                                                    <XCircleIcon class="h-5 w-5 text-blue-700" @click="
                                                        deleteRequisito(
                                                            index
                                                        )
                                                        " />
                        ...
                        <TabPanel>
                            <div class="max-w-8xl">
                                <div class="inline-grid grid-row-4 grid-cols-4 gap-4 max-h-96 h-96 overflow-hidden">
                                    <div class="col-span-4 flex items-center justify-center">
                                        <jet-label for="tarea" value="Nueva Tarea"
                                            class="text-lg font-semibold mx-2 p-2" />
                                        <jet-input id="tarea" type="text" class="mt-1 border-blue-400" v-model="task"
                                            size="44" maxsize="44" />
                                    ...
                                    <ul class="col-span-4 overflow-y-auto">
                                        <ol class="flex flex-row">
                                            ...
                                            <p class="font-semibold text-lg w-2/3">
                                                Descripción
                                            </p>
                                        </ol>
...
const addRequisito = (requisito) => {
    ...
    if (form.requisitos.some((elem) => elem.id === requisito.id)) return;
    if (!form.requisitos.includes(requisito)) {
        form.requisitos.push(requisito);
    }
};
const findRequisito = (requisito) =>
    form.requisitos.some((elem) => elem.id === requisito.id);
