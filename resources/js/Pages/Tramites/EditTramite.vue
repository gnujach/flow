        ...
        <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
            <jet-form-section @submit.prevent="
                ...
                <template #form>
                    ...
                    <div class="col-span-6 sm:col-span-4">
                        <jet-label for="fundamento_jur" value="fundamento_jur" />
                        <jet-input id="fundamento_jur" type="text" class="mt-1 block w-full"
                            v-model="form.fundamento_jur" autocomplete="fundamento_jur" />
                        <jet-input-error :message="form.errors.fundamento_jur" class="mt-2" />
                    </div>
                    <div class="col-span-6 sm:col-span-4">
                        <jet-label for="costo" value="Costo del Trámie" />
                        <jet-input id="costo" type="text" class="mt-1 block w-full" v-model="form.costo"
                            autocomplete="costo" />
                        <jet-input-error :message="form.errors.costo" class="mt-2" />
                    </div>
                    <div class="col-span-6 sm:col-span-4">
                        <jet-label for="plazo_respuesta" value="Plazo de Respuesta" />
                        <jet-input id="plazo_respuesta" type="text" class="mt-1 block w-full"
                            v-model="form.plazo_respuesta" autocomplete="plazo_respuesta" />
                        <jet-input-error :message="form.errors.plazo_respuesta" class="mt-2" />
                    </div>
                    <div class="col-span-6 sm:col-span-4">
                        <jet-label for="url_proceso" value="URL Tramite" />
                        <jet-input id="url_proceso" type="text" class="mt-1 block w-full" v-model="form.url_proceso"
                    ...
                    <div class="col-span-6 sm:col-span-4">
                        ...
                        <BaseListbox :options="modalidad" placeholder="Seleccione Modalidad" v-model="form.modalidad" />
                        <jet-input-error :message="form.errors.modalidad" class="mt-2" />
                    </div>
                    <div class="col-span-6 sm:col-span-4">
                        <jet-label for="modalidad" value="Tipo de usuario a quien va dirigido el trámite" />
                        <BaseListbox :options="tipoUsuarios" placeholder="Seleccione Tipo de Usuario"
                            v-model="form.tipo_usuario" />
                        <jet-input-error :message="form.errors.tipo_usuario" class="mt-2" />
                    </div>
                    <div class="col-span-6 sm:col-span-4">
                        <jet-label for="departamento" value="Departamento dueño del trámite" />
                    ...
                    <div class="col-span-6 sm:col-span-4">
                        ...
                        <BaseListbox :options="tipos" placeholder="Tipo de Trámite" v-model="form.tipo" />
                        <jet-input-error :message="form.errors.tipo" class="mt-2" />
                    </div>
                    <div class="col-span-6 sm:col-span-4">
                        <jet-label for="departamento" value="Tipo de Respuesta" />
                        <BaseListbox :options="ser_recibo" placeholder="Servicio de Recibido"
                            v-model="form.ser_recibido" />
                        <jet-input-error :message="form.errors.ser_recibido" class="mt-2" />
                    </div>
