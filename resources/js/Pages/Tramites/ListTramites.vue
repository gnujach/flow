                        ...
                        <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
                            <div class="mt-8 flex flex-row m-2">
                                ...
                                <div class="w-1/2 flex justify-end">
                                    <jet-nav-link :href="route('admin.tramites/create', {})
                                        ">
                                        <button
                            ...
                            <div class="bg-white rounded shadow overflow-x-auto ml-4 mr-4">
                                <table class="w-full">
                                    ...
                                    <tr v-for="tramite in tramites.data
                                        .tramites" :key="tramite.data.id"
                                        ...
                                        <td class="border-t">
                                            <div
                                                ...
                                                <XCircleIcon v-else class="w-5 h-5 ml-3 pointer-events-none" />
                                            </div>
                                        </td>
                                    </tr>
                                </table>
