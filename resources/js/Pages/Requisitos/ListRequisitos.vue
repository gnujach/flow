                        ...
                        <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
                            <div class="mt-8 flex flex-row m-2">
                                ...
                                <div class="w-1/2 flex justify-end">
                                    <jet-nav-link :href="route('admin.requisitos/create', {})
                                        "><button
                            ...
                            <div class="bg-white rounded shadow overflow-x-auto ml-4 mr-4">
                                <table class="w-full">
                                    <tr class="text-left font-bold bg-aqua">
                                        ...
                                        <th class="px-6 pt-6 pb-4">
                                            <div class="flex content-center items-center">
                                                <icon name="sun" class="w-8 h-8 mr-2 text-indigo-900" />Objetivo
                                            </div>
                                        </th>
                                        <th class="px-6 pt-6 pb-4">
                                            <div class="flex content-center items-center">
                                                <icon name="sun" class="w-8 h-8 mr-2 text-indigo-900" />Acciones
                                            </div>
                                        </th>
                                    </tr>
                                    <tr v-for="requisito in requisitos.data
                                        .requisitos" :key="requisito.data.id"
                                        ...
                                        <td class="border-t">
                                            <div
                                                ...
                                                <CheckIcon v-else class="w-5 h-5 ml-3 pointer-events-none" />
                                            </div>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <div class="max-w-3xl mx-auto sm:px-6 lg:px-8 pt-4">
                                <pagination :meta="requisitos.meta" />
                            </div>
                        </div>
                    </div>
                </div>
