                        ...
                        >
                            ...
                            >
                                ...
                                <div
                                    ...
                                    v-for="solicitud in cliente.data.solicitudes
                                        .solicitudes"
                                >
                                    <span class="w-1/5">{{
                                    ...
                                    <span class="w-1/5">{{
                                        `${solicitud.data.attributes.created} (${solicitud.data.attributes.diffForHumans})`
                                    }}</span>
                                    <span class="w-1/5">{{
