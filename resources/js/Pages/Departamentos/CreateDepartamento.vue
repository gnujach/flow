<template>
    <app-layout>
        ...
        <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
            ...
            <jet-form-section @focusout="validate" @submitted="saveDepartamentoInformation">
                ...
                <template #form>
                    <div class="col-span-6 sm:col-span-4">
                        ...
                        <jet-input id="nombre" type="text" class="mt-1 block w-full" v-model="form.nombre" autofocus />
