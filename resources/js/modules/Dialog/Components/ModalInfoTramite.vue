<template>
    <div class="flex items-center justify-center">
        <button v-bind="$attrs" type="button" @click="showTramite(tram)"
            ...
            <EllipsisHorizontalIcon class="flex-none text-blue-800 -ml-1 w-5 h-5 rounded-md" aria-hidden="true" />
        </button>
                    ...
                    <div
                        ...
                        <div class="flex flex-row justify-between items-center border-b border-gray-300">
                            <div class="inset-y-0 left-0 flex items-center pl-4 pointer-events-none">
                                <InformationCircleIcon class="flex-none text-gray-700 -ml-1 w-5 h-5 ring-1"
                                    aria-hidden="true" />
                            </div>
                            <p class="uppercase">{{ tram.nombre }}</p>
                            <div class="inset-y-0 right-0 flex items-center pr-3 my-2">
                                <button @click="toggleModalInfoTramite" type="button"
                            ...
                            <div class="ring-1 border border-blue-500 rounded-md m-4">
                                ...
                                <div class="flex flex-row m-4 ">
                                    ...
                                    <div class="w-3/4">
                                        <ul
                                            class="text-lg font-semibold lowercase antialiased italic decoration-slate-200 indent-4 bg-gray-100 rounded-md">
                                            <li v-for="requisito in tram.requisitos" :key="requisito.id">
