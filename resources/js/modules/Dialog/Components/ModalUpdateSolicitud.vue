<template>
    <div class="flex items-center justify-center">
        <button v-bind="$attrs" type="button" @click="openModalUpdateUser(uuid)"
            ...
            <PencilIcon class="flex-none text-blue-800 ml-1 w-5 h-5" aria-hidden="true" />
        </button>
...
import { ArrowDownIcon, CheckIcon } from "@heroicons/vue/24/solid";
